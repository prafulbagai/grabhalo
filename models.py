...
class DataGrabhalouser(models.Model):
    id = models.IntegerField(primary_key=True)
    ...
    user = models.ForeignKey(AuthUser)
    class Meta:
        db_table = 'data_grabhalouser'

class DataWebquery(models.Model):
    user_id = models.BigIntegerField()
    conversation_id = models.BigIntegerField(primary_key=True)
    sent_to = models.CharField(max_length=500L)
    user_query = models.CharField(max_length=500L)
    date_time = models.DateTimeField()
    class Meta:
        db_table = 'data_webquery'

class DataWebreply(models.Model):
    id = models.IntegerField(primary_key=True)
    conversation_id = models.BigIntegerField()
    user_id = models.BigIntegerField()
    sent_to = models.BigIntegerField()
    chat = models.CharField(max_length=500L)
    date_time = models.DateTimeField()
    class Meta:
        db_table = 'data_webreply'
